...
ru_journals = result[result['journal_index'] == 'ru'].copy()
ni_journals = result[result['journal_index'] == 'ni'].copy()
ru_journals.to_sql('psal_29_ru_journals', engine, if_exists='replace', index=False)
ni_journals.to_sql('psal_29_ni_journals', engine, if_exists='replace', index=False)
